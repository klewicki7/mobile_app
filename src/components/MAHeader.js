...
import {MALogoHorizontal} from "../components/MALogo";

const MAHeader = ({navigation, transparent, back, onSettings}) => (
    <View style={back ? {...styles.mainBarContainer, borderBottomWidth: 0} : styles.mainBarContainer}>
        <View style={getMainbarStyle(transparent, back)}>
        {
            ...
            {
                !back &&
                <MALogoHorizontal style={{marginRight: scale(1)}}/>
                
            }
            <Icon
                            style={{color:'transparent', width:scale(11)}}
                            type={'MaterialIcons'} name={'menu'}
                        />
